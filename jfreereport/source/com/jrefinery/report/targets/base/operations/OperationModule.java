 ...
 *
 * $Id: OperationModule.java,v 1.1 2003/01/29 03:13:01 taqua Exp $
 *
 * Changes
 * -------
 */
...
public abstract class OperationModule
{
   ...
   * @return the content.
   *
   * @throws com.jrefinery.report.targets.pageable.OutputTargetException if there is a problem with the OutputTarget.
   */
