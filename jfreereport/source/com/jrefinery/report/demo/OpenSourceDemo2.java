...
public class OpenSourceDemo2 extends ApplicationFrame implements ActionListener
{
	...
	private void configureItemBand(ItemBand band)
	{
		...
		ess.setFontStyleProperty(new Font("SansSerif", Font.PLAIN, 9));
        ...
        field1.getStyle().setFontStyleProperty(new Font("SansSerif", Font.BOLD, 10));
        ...
        field2.getStyle().setFontStyleProperty(new Font("Monospaced", Font.PLAIN, 8));       
