 ...
 * Contributor(s):
 *
 * $Id: ExportToHtmlAction.java,v 1.4 2003/06/27 14:25:16 taqua Exp $
 *
 * Changes
 * -------
...
/**
 * Export to Html action for a print preview frame.
 *
...
public abstract class ExportToHtmlAction extends AbstractActionDowngrade
{
   ...
   */
  public ExportToHtmlAction(final ResourceBundle resources)
  {
