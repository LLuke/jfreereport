 ...
 * Contributor(s):   -;
 *
 * $Id: PreviewFrame.java,v 1.2 2002/05/07 14:26:27 mungady Exp $
 *
 ...
 */
public class PreviewFrame extends JFrame implements ActionListener, PropertyChangeListener, JFreeReportConstants
{
  ...
  public PreviewFrame (JFreeReport report)
  {
    ...
    addWindowListener (new WindowAdapter ()
    {
      ...
      {
        ActionEvent event = new ActionEvent (this, ActionEvent.ACTION_PERFORMED, CLOSE_COMMAND);
  ...
  protected ReportPane createReportPane ()
  {
    ...
    ReportPane reportPane = new ReportPane (report, new G2OutputTarget (null, getDefaultPageFormat ()));
  ...
  public void doSaveAs () throws IOException
  {
    ...
    if (option == JFileChooser.APPROVE_OPTION)
    {
      ...
      {
        JOptionPane.showMessageDialog (this, "Error on processing this report: " + re.getMessage ());
      }
      target.close ();
    }
  ...
  {
    this.saveAsAction = createDefaultSaveAsAction ();
    this.pageSetupAction = createDefaultPageSetupAction ();
    this.printAction = createDefaultPrintAction ();
    this.aboutAction = createDefaultAboutAction ();
    this.closeAction = createDefaultCloseAction ();
  }
