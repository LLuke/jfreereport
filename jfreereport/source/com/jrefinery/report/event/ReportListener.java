...
/**
 * ReportListeners get informed whenever the state of an report changes. You should be
 * aware, that most events occur more than once, the reportStarted-Event will be triggered
 * everytime the report is regenerated.
 *
