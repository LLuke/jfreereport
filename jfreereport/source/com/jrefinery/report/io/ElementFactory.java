...
public class ElementFactory extends AbstractReportDefinitionHandler implements ReportDefinitionTags
{
  ...
  public ImageElement generateImageElement (Attributes atts)
    throws SAXException
  {
    ...
    try
    {
      ImageReference imgRef = new ImageReference (new URL (handler.getContentBase (), elementSource), getElementPosition(atts));
  ...
  public ShapeElement generateLineElement (Attributes atts)
    throws SAXException
  {
  ...
  public LabelElement generateLabelElement (Attributes attr)
          throws SAXException
  {
  ...
  public MultilineTextElement generateMultilineElement (Attributes attr)
          throws SAXException
  {
  ...
  public StringElement generateStringElement (Attributes attr)
          throws SAXException
  {
  ...
  public GeneralElement generateGeneralElement (Attributes attr)
          throws SAXException
  {
  ...
  public NumberElement generateNumberElement (Attributes attr)
          throws SAXException
  {
  ...
  public DateElement generateDateElement (Attributes attr)
          throws SAXException
  {
          ...
          throws SAXException
  {
    ...
    if (s != null)
    {
      if (s.equals ("left")) elementAlignment = Element.LEFT;
      if (s.equals ("center")) elementAlignment = Element.CENTER;
      if (s.equals ("right")) elementAlignment = Element.RIGHT;
    }
  ...
  protected Rectangle2D getElementPosition (Attributes atts)
          throws SAXException
  {
    // x
