 ...
 *
 *
 * $Id: JFreeReportResources_hu.java,v 1.01 2003/05/02 20:28:54 demeterft@dremium.com Exp $
 *
 *
 */
  ...
  private static final Object[][] CONTENTS =
      {
            ...
            {"csvexportdialog.export.printed_elements", "Nyomtatott elemek exportálása (Megjelenített adatok)"},
            {"csvexportdialog.strict-layout", "Pontos táblamegjelenítés az exportáláskor."},


            {"plain-text-exportdialog.dialogtitle", "A lista exportálása egyszerû szöveges fájlba..."},
