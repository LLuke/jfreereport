 ...
 *
 * $Id: ReportEvent.java,v 1.5 2005/01/28 19:26:48 taqua Exp $
 *
...
/**
 * Represents a report event. <P> Includes information regarding which {@link ReportState}
 * generated the event.
 *
...
public class ReportEvent extends EventObject
{
  ...
  /**
   * The event type constant, that this event is a prepare event. Use this constant in
   * combination with one of the other event types to specify which kind of event was
   * prepared.
   */
   ...
   *
   * @param state the current state of the processed report (<code>null</code> not
   *              permmitted).
  ...
  /**
   * Returns the report that generated the event. <P> This is a convenience method that
   * extracts the report from the report state.
   *
   * @return the report.
   */
   ...
   * <p/>
   * The {@link DataRow} is used to access the fields of the {@link
   * org.jfree.report.filter.DataSource} and other functions and expressions within the
