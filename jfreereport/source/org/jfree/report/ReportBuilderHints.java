 ...
 * instance. This information can be used to support automated processes on the
 * JFreeReport definition.
 * <p/>
 * The XML parsers use this collection to store comments and other metadata for their
 * reports.
 * <p/>
 * The report builder hints are not copied when a report is cloned and are not available
 * during the report processing.
 * <p/>
 * The following hints are known: <table> <tr> <th>Name</th> <th>Type</th> </tr> <tr>
 * <th>&nbsp;</th> <th>Comments</th> </tr> <tr> <td><code>org.jfree.report.modules.parser.base.ReportParser</code></td>
 * <td><code>java.util.List</code>, which contains <code>org.jfree.report.modules.parser.base.OperationResult</code>
 * objects.</td> </tr> <tr> <td>&nbsp;</td> <td>All parser errors, warnings and infos that
 * are generated by the SAX parser</td> </tr> <tr> <td></td> <td></td> <td></td> </tr>
 * </table>
 *
...
{
  /**
   * Defines whether the report builder should be paranoid when accepting objects for
   * storage.
   */
  ...
  public static class ParserHintKey implements Serializable
  {
    ...
    /**
     * Compares whether this key points to the same object and refers to the same key
     * name.
     *
   ...
   */
  public void putHint (final Serializable target, final String hint,
                       final Serializable hintValue)
  {
  ...
  /**
   * Queries the object to get a stored hint from this collcetion and checks that the
   * target object has the correct type. This will return null, if the hintobject is not
   * assignable from the given object type.
   *
   * @param target     the target object, to which the hint is assigned.
   * @param hint       the name of the hint.
   ...
   * IllegalArgumentException is thrown. If the speocified hint value is already contained
   * in that list, no action is taken.
   *
  ...
  public void addHintList (final Serializable target,
                           final String hint, final Serializable hintValue,
