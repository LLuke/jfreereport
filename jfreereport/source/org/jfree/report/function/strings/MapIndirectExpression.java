 ...
 * Contributors: -;
 *
 * $Id: MapIndirectExpression.java,v 1.2 2006/02/10 14:58:43 taqua Exp $
 *
 * Changes
 * -------------------------
...
public class MapIndirectExpression extends AbstractExpression
{
  ...
  public void queryDependencyInfo(final ExpressionDependencyInfo info)
  {
    ...
    final String[] dependendFields = new String[2 + forwards.size()];
    for (int i = 0; i < forwards.size(); i++)
    {
      dependendFields[i] = (String) forwards.get(i);
    }
    dependendFields [forwards.size()] = getField();
    dependendFields [forwards.size() + 1] = getFallbackForward();
    info.setDependendFields(dependendFields);
  }
