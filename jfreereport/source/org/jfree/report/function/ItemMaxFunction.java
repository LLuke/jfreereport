...
public class ItemMaxFunction extends AbstractFunction implements Serializable
{
   ...
   * defined for the function, then the maximum value is reset to zero.
   *
   * @param event Information about the event.
   */
  ...
  /**
   * Sets the group name. <P> If a group is defined, the maximum value is reset to zero at
   ...
   * field defined for this function and performs the maximum value comparison with its
   * old value.
   *
   * @param event Information about the event.
   */
