...
public class CSVReaderDemo extends AbstractDemoFrame
{
  ...
  public CSVReaderDemo ()
  {
    ...
    this.setTitle("CSVTableModelProducer Demos");
  }
  ...
  protected void attemptPreview ()
  {
    ...
    report.setName("CSVTableModelProducer API demos");
  ...
  protected void attemptStringApiPreview ()
          throws IOException
  {
    this.data = new CSVTableModelProducer(new BufferedReader(new StringReader(text))).getTableModel();
    this.attemptPreview();
  }
  ...
  protected void attemptStringDefApiPreview ()
          throws IOException
  {
    final CSVTableModelProducer csv = new CSVTableModelProducer(new BufferedReader(new StringReader(textColumn + text)));
  ...
  private void configurePageHeader (final PageHeader header)
  {
    ...
    title.setText("CSVTableModelProducer Demos by Mimil");
