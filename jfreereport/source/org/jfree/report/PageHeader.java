 ...
 *
 * $Id: PageHeader.java,v 1.8 2005/02/23 19:31:40 taqua Exp $
 *
...
/**
 * A report band used to print information at the top of every page in the report.  There
 * is an option to suppress the page header on the first page and the last page of the
