 ...
 * Contributor(s):   -;
 *
 * $Id: DefaultLayoutControler.java,v 1.7 2006/11/11 20:37:23 taqua Exp $
 *
 * Changes
 * -------
 *
 ...
 */
public class DefaultLayoutController implements LayoutController
{
  public DefaultLayoutController()
  {
  }
      ...
      ReportProcessingException
  {
    ...
    // nodes are easy ...
    FlowController fc = pos.getFlowControler();
  ...
  private DefaultLayoutPosition endElement(final DefaultLayoutPosition pos,
                                           final Element e,
  ...
  public FlowController processFlowOperations(FlowController fc,
  ...
  /**
   * Ignore the contents of the current element. Skip to the next element on the
   * same level. If there is no next element, return the parent ...
   *
   * @param position
                                               ...
                                               final FlowController flowController)
  {
    ...
    if (parent == null)
    {
      ...
      return new DefaultLayoutPosition(flowController, null);
    }
    ...
    if (parentNode instanceof Section)
    {
      ...
      if (nodeIndex >= 0 && ((nodeIndex + 1) < parentSection.getNodeCount()))
      {
        ...
        return position.deriveSilblingPosition(flowController, nextNode);
      }
    }

    // closing down. How about a repeat operation?
    return parent.derive(flowController);
  }
  ...
  {
    return new DefaultLayoutPosition(flowController, initialNode);
  }
}
