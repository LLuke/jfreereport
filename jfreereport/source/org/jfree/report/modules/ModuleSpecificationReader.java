 ...
 *
 * ------------------------------
 * ModuleSpecificationReader.java
 * ------------------------------
...
public final class ModuleSpecificationReader
{
  ...
  public static ModuleSpecificationReader getInstance ()
  {
    if (reader == null)
    {
      reader = new ModuleSpecificationReader();
    }
    return reader;
  }

  private ModuleSpecificationReader()
  {
  }

  public void load (AbstractModule module) throws IOException
  {
    if (module == null)
    {
