 ...
 * worker thread.
 * <p/>
 * These task objects are one-time objects and should (and hopefully cannot) not be
 * reused.
 *
...
public abstract class ExportTask implements Runnable
{
  ...
  /**
   * Returns the return value of the task. The caller should test, whether the task is
   * done, before querying the result.
   *
  ...
  /**
   * Returns the exception that caused the task to fail, or null if not set or known.
   *
  ...
  /**
   * Call this method to signal, that the task is completed and the result is computed and
   * all state information is stored.
   * <p/>
  ...
  /**
   * Call this method to signal, that the task was aborted by the user or the system.
   * <p/>
  ...
  /**
   * Call this method to signal, that an error occured while trying to complete the task.
   * <p/>
  ...
  /**
   * Adds an export task listener to this task. The listener will be informed when the
   * task is either aborted or finished.
   *
  ...
  /**
   * Informs all registered listeners, that the report was aborted due to unexpected
   * errors.
   */
  ...
  /**
   * Informs all registered listeners, that the report processing was aborted by the
   * user.
   */
  ...
  /**
   * Starts the export by calling performExport. If perfomExport causes Exceptions, the
