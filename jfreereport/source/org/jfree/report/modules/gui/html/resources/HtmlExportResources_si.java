 ...
 * Contributor(s):   -;
 *
 * $Id: HtmlExportResources_si.java,v 1.5 2003/09/08 18:39:33 taqua Exp $
 *
 * Changes
 * -------------------------
...
public class HtmlExportResources_si extends JFreeReportResources
{
  ...
  private static final Object[][] CONTENTS =
      {
        ...
        {"error.savefailed.message", "Napaka pri shranjevanju datoteke: {0}"},
  ...
  {
    new HtmlExportResources_si().generateResourceProperties("slovenian");
    System.exit(0);
  }
}
