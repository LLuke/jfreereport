 ...
 * Contributor(s):   -;
 *
 * $Id: IBMCompatiblePrinterDriver.java,v 1.6 2005/04/17 21:09:01 taqua Exp $
 *
 * Changes
 * -------
 *
...
public class IBMCompatiblePrinterDriver implements PrinterDriver
{
    ...
    public PrinterEncoding getEncoding (final String encoding)
    {
      try
      {
        return new PrinterEncoding
                (encoding, encoding, encoding, translateCodePage(encoding));
      }
          ...
          throws IOException
  {
    ...
    sendFontStyle(fd.isBold(), fd.isItalic(), fd.isUnderline());
