 ...
 *
 * $Id: ImageReferenceData.java,v 1.4 2003/11/21 14:48:17 taqua Exp $
 *
 * Changes
 * -------
 ...
 */
public class ImageReference extends HtmlReference
{
   ...
   */
  public ImageReference(final String reference)
  {
    super(true);
    if (reference == null)
    {
