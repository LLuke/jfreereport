 ...
 */
public class AppendingExcelProcessor extends ExcelProcessor
{
  ...
  public AppendingExcelProcessor(final JFreeReport report)
  ...
  protected TableCreator createContentCreator()
  {
    ...
    {
      tableCreator = new ProxyTableCreator(super.createContentCreator());
    }
    return tableCreator;
  }
