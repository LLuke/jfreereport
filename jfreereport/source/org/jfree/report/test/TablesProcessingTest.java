 ...
 * Contributor(s):   -;
 *
 * $Id: TablesProcessingTest.java,v 1.1 2006/11/20 21:10:40 taqua Exp $
 *
 * Changes
 * -------
 *
 ...
 */
public class TablesProcessingTest
{
  private TablesProcessingTest()
  {
  }
...
//    TextProcessingTest.processFlowReport("/baseline.xml");
    TablesProcessingTest.processFlowReport("/tables.xml");
  }
  ...
  {
    URL url = TablesProcessingTest.class.getResource(file);
