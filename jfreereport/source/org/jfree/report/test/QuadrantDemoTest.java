 ...
 */
public class QuadrantDemoTest
{
  private QuadrantDemoTest()
  {
  }
          ...
          ResourceLoadingException, ReportProcessingException
  {
    ...
    QuadrantDemoTest.processFlowReport("/quad.xml");
  }
  ...
  {
    URL url = QuadrantDemoTest.class.getResource(file);
