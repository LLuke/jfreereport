 ...
 * Contributor(s):   -;
 *
 * $Id: RepeatedHeaderTest.java,v 1.1 2006/11/20 21:10:40 taqua Exp $
 *
 * Changes
 * -------
 *
 ...
 */
public class RepeatedHeaderTest
{
  private RepeatedHeaderTest()
  {
  }
          ...
          ResourceLoadingException, ReportProcessingException
  {
    ...
    RepeatedHeaderTest.processFlowReport("/repeated-headers.xml");
  }
  ...
  {
    URL url = RepeatedHeaderTest.class.getResource(file);
