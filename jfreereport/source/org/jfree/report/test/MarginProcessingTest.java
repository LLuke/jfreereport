 ...
 * Contributor(s):   -;
 *
 * $Id: MarginProcessingTest.java,v 1.1 2006/11/20 21:10:40 taqua Exp $
 *
 * Changes
 * -------
 *
 ...
 */
public class MarginProcessingTest
{
  private MarginProcessingTest()
  {
  }
          ...
          ResourceLoadingException, ReportProcessingException
  {
    ...
    MarginProcessingTest.processFlowReport("/margins.xml");
  }
  ...
  {
    URL url = MarginProcessingTest.class.getResource(file);
