// MfDcState - track the state of the DC of a Windows metafile.
//
...
/**
 Track the state of the DC of a Windows metafile.
 */
public class MfDcState implements Cloneable
{
  public class MfScale
  {
    ...
    {
      return (int) ((coord * xNum) / xDenom);
    }

    public int scaleY (int coord)
    {
      return (int) ((coord * yNum) / yDenom);
    }
  }
