 ...
 * Time: 3:03:51 PM
 *
 * $Id: WmfGraphics2D.java,v 1.4 2004/01/19 18:36:25 taqua Exp $
 */
...
public class WmfGraphics2D extends AbstractGraphics2D
{
   ...
   * @param x the x-coordinates where the <code>String</code> should be rendered
   * @param y the y-coordinates where the <code>String</code> should be rendered
