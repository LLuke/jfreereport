...
//
//public class InlineLayoutTest extends TestCase
//{
//  public InlineLayoutTest (final String s)
//  {
//    super(s);
//  }
//
...
//  {
//    final TestDocumentElement root = TestDocumentElement.createInlineLayoutElement("root");
//    root.addChild(TestDocumentElement.createInlineLayoutElement("child1"));
//    root.addChild(TestDocumentElement.createInlineLayoutElement("child2"));
//    final TestDocumentElement child = TestDocumentElement.createInlineLayoutElement("child3");
//    root.addChild(child);
//    child.addChild(TestDocumentElement.createInlineLayoutElement("child3-1"));
//    child.addChild(TestDocumentElement.createInlineLayoutElement("child3-2"));
//    root.addChild(TestDocumentElement.createInlineLayoutElement("child4"));
//
