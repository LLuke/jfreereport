...
public class FontDefinition implements Serializable, Cloneable
{
  ...
  {
    return startsWithIgnoreCase(fontName, "SansSerif")
        || startsWithIgnoreCase(fontName, "Dialog");
  }
  ...
  {
    return (startsWithIgnoreCase(fontName, "dialoginput")
        || startsWithIgnoreCase(fontName, "monospaced"));
  }
  ...
  {
    return (startsWithIgnoreCase(fontName, "serif"));
  }
