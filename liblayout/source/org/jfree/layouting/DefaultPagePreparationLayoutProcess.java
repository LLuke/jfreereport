 ...
 *
 * ------------
 * DefaultPagePreparationLayoutProcess.java
 * ------------
 ...
 */
public class DefaultPagePreparationLayoutProcess extends AbstractLayoutProcess
  implements PagePreparationLayoutProcess
{
  private PageableOutputProcessor processor;

  public DefaultPagePreparationLayoutProcess(PageableOutputProcessor processor)
  {
    super(processor);
  ...
  {
    return processor.createPrepareNormalizer();
  }
}
