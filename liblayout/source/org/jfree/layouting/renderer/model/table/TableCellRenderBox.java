 ...
 * Contributor(s):   -;
 *
 * $Id: TableCellRenderBox.java,v 1.4 2006/07/22 15:28:50 taqua Exp $
 *
 * Changes
 * -------
 *
...
public class TableCellRenderBox extends BlockRenderBox implements TableCell
{
  ...
  {
    super(boxDefinition);
    this.verticalAlignment = VerticalAlign.BASELINE;
  ...
  private CSSValue normalizeAlignment(CSSValue verticalAlignment)
  {
