 ...
 */
public class CounterFunction extends AbstractStyleFunction
{
          ...
          throws FunctionEvaluationException
  {
    ...
    final int cval = element.getElementContext().getCounterValue(counterName);
    ...
    return new CSSStringValue(CSSStringType.STRING, counterText);
  }
}
