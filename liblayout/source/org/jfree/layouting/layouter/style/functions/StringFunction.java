 ...
 */
public class StringFunction extends AbstractStyleFunction
{
          ...
          throws FunctionEvaluationException
  {
    ...
    final String name = getStringParameter(layoutProcess, element, params[0]);
    final Object attribute = layoutProcess.getDocumentContext().getString(name);
    // todo: The string to be printed should be taken from the page context  ...
    return new CSSStringValue(CSSStringType.STRING, String.valueOf(attribute));
  }
}
