 ...
 * Contributors: -;
 *
 * $Id: WordBreakResolveHandler.java,v 1.1 2006/02/12 21:49:33 taqua Exp $
 *
 * Changes
 * -------------------------
...
public class WordBreakResolveHandler extends ConstantsResolveHandler
{
  ...
  public void resolve(final LayoutProcess process,
                      ...
                      StyleKey key)
  {
    final WordBreak value =
            (WordBreak) resolveValue(process, currentNode, style, key);
    ...
    processingSpecifcation.setWordBreak(value);
