 ...
 * Contributors: -;
 *
 * $Id: TextJustifyTrimResolveHandler.java,v 1.1 2006/02/12 21:49:33 taqua Exp $
 *
 * Changes
 * -------------------------
...
public class TextJustifyTrimResolveHandler extends ConstantsResolveHandler
{
  ...
  public void resolve(final LayoutProcess process,
                      ...
                      StyleKey key)
  {
    final TextJustifyTrim value =
            (TextJustifyTrim) resolveValue(process, currentNode, style, key);
    ...
    alignmentSpecifcation.setTextJustifyTrim(value);
  }
