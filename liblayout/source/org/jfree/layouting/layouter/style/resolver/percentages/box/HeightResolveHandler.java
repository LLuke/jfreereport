 ...
 * Contributors: -;
 *
 * $Id: HeightResolveHandler.java,v 1.1 2006/02/12 21:49:33 taqua Exp $
 *
 * Changes
 * -------------------------
...
public class HeightResolveHandler implements ResolveHandler
{
  ...
  public void resolve(LayoutProcess process,
                      ...
                      StyleKey key)
  {
    final CSSValue displayModel = style.getValue(BoxStyleKeys.DISPLAY_MODEL);
    if (DisplayModel.ABSOLUTE.equals(displayModel))
    {
      // we accept percentages for that model. Percentages for the width behave
      // different in the compatibility mode.
      return;
    }
  ...
  protected CSSValue getParentWidth(LayoutNode currNode, double percentage)
  {
    ...
    final TextSpecification textSpecification =
            parent.getLayoutContext().getTextSpecification();
