 ...
 * Contributors: -;
 *
 * $Id: BackgroundOriginResolveHandler.java,v 1.1 2006/02/12 21:49:32 taqua Exp $
 *
 * Changes
 * -------------------------
 ...
 */
public class BackgroundOriginResolveHandler
        extends ListOfConstantsResolveHandler
{
  public BackgroundOriginResolveHandler()
  {
    addNormalizeValue(BackgroundOrigin.BORDER);
    addNormalizeValue(BackgroundOrigin.PADDING);
    addNormalizeValue(BackgroundOrigin.CONTENT);
  }
  ...
  protected boolean resolveItem(final LayoutProcess process,
                                ...
                                CSSConstant item)
  {
    BackgroundOrigin bvalue = (BackgroundOrigin) lookupValue(item);
