 ...
 *
 * ------------
 * InlineCompositionStrategy.java
 * ------------
 ...
 * Contributor(s):   -;
 *
 * $Id: InlineCompositionStrategy.java,v 1.1 2006/04/17 21:04:27 taqua Exp $
 *
 * Changes
 * -------
 *
...
/**
 * This is very simple. Find the next 'containing block' and add the elements
 * to a linebox there.
 *
 * @author Thomas Morgner
 */
public class InlineCompositionStrategy extends LineBoxCompositionStrategy
{
  public InlineCompositionStrategy()
  {
  }
  ...
  public void addElement(ContentBox parent, ContentNode node)
  {
    ...
    if (parent == null)
    {
      throw new NullPointerException("Given parent for " + node + " cannot be null");
    }

    ContentBox blockContext = parent;
    while (blockContext.isContainingBlock() == false)
    {
      ContentBox o = blockContext;
