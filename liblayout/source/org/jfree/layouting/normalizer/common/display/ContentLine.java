 ...
 * Contributor(s):   -;
 *
 * $Id: ContentLine.java,v 1.1 2006/04/17 21:04:27 taqua Exp $
 *
 * Changes
 * -------
 *
...
/**
 * A line box is an anonymous paragraph/block box which is generated
 * during the display model generation. It only contains inline elements.
 *
...
public class ContentLine extends ContentBox
{
  ...
  /**
   * A linebox is always a block element
   *
