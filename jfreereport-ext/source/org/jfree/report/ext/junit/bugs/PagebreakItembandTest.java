...
public class PagebreakItembandTest
{
  private static final String URLNAME = "org/jfree/report/ext/junit/bugs/resource/pagebreak-before-itemband.xml";

  private PagebreakItembandTest ()
  {
  }
  ...
  public static void main(final String[] args) throws Exception
  {
    ...
    final URL in = ObjectUtilities.getResource
            (URLNAME, PagebreakItembandTest.class);
