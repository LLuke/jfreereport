 ...
 * Contributor(s):   -;
 *
 * $Id: APReportTest.java,v 1.4 2005/05/31 18:28:01 taqua Exp $
 *
 * Changes
 * -------
 *
...
public class MissingColumnsReportTest
{
  private static final String URLNAME = "org/jfree/report/ext/junit/bugs/resource/missing-columns.xml";

  private MissingColumnsReportTest()
  {
  }
  ...
  public static void main(final String[] args) throws Exception
  {
    ...
    final URL in = ObjectUtilities.getResource
            (URLNAME, MissingColumnsReportTest.class);
