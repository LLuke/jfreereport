 ...
 *
 * $Id: SampleReport1.java,v 1.5 2003/09/15 15:31:58 taqua Exp $
 *
 * Changes:
 * --------
...
import org.jfree.report.ext.junit.base.basic.modules.table.tableverify.VerifyCell;
 ...
 * This report is used as report definition for the table export verification
 * test.
 *
 * @author Thomas Morgner
 */
public class TableVerifyDefinition
{
  /**
  ...
  private void addGroupHeader (VerifyPattern pattern)
  {
    // group header
    pattern.addRow();
  ...
  private void addItemBand (int count, VerifyPattern pattern)
  {
    // itemband
  ...
  private void addGroupFooter (VerifyPattern pattern)
  {
    pattern.addRow();
    pattern.addCell(new VerifyCell (0, 0, 2, 1));
    pattern.addCell(new VerifyCell (2, 0, 1, 1));
  ...
  public VerifyPattern createPattern ()
  {
    ...
    // afrika : 2 countries
    addGroupInstance(2, pattern);
    // asia : 3 countries
    addGroupInstance(3, pattern);
    // australia : 1 countries
    addGroupInstance(1, pattern);
    // europe : 14 countries
    addGroupInstance(14, pattern);
  ...
  private void addGroupInstance (int itemcount, VerifyPattern pattern)
  {
    addGroupHeader(pattern);
    addItemBand(itemcount, pattern);
    addGroupFooter(pattern);
  }
}