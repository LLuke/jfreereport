 ...
 *
 * $Id: ContentTestSuite.java,v 1.2 2003/09/09 10:27:57 taqua Exp $
 *
 * Changes
 * -------------------------
...
public class ContentTestSuite extends TestSuite
{
  public ContentTestSuite(final String s)
  {
    ...
    addTestSuite(ImageContentTest.class);
    addTestSuite(ShapeContentTest.class);
    addTestSuite(TextContentTest.class);
  }
  ...
  {
    return new ContentTestSuite(ContentTestSuite.class.getName());
  }
