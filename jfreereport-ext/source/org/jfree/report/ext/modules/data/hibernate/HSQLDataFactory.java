 ...
 */
public class HSQLDataFactory extends SimpleHSQLDataFactory
{
  private ResourceKey contentBase;
  private HashMap querymappings;

  public HSQLDataFactory(final Session connection)
  {
    super(connection);
    querymappings = new HashMap();
  }

  public HSQLDataFactory(final SessionProvider connectionProvider)
  {
