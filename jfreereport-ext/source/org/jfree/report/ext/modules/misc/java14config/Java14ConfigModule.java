...
public class Java14ConfigModule extends AbstractModule
{
          ...
          throws ModuleInitializeException
  {
    ...
    if (value.equals(org.jfree.report.ext.modules.misc.java14config.Java14ConfigModule.JAVA14_CONFIG_STORE_CLASS) == false)
    {
      Log.debug ("Java 1.4 Config module not active.");
      return;
    }
    // this will result in an caught exception if JDK 1.4 is not available.
    performExternalInitialize(org.jfree.report.ext.modules.misc.java14config.Java14ConfigModule.JAVA14_CONFIG_STORE_INITIALIZER);
  }
}
