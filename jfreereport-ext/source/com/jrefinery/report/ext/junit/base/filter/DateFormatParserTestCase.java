 ...
 *
 * $Id: DateFormatParserTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>DateFormatParserTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.DateFormatParserTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class DateFormatParserTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected DateFormatParser varDateFormatParser;

  /**
   * Public constructor for creating testing class.
   */
  public DateFormatParserTestCase(String name) {
    super(name);
  } // end of DateFormatParserTestCase(String name)
  /**
  ...
  protected void setUp() {
    varDateFormatParser = new DateFormatParser();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(DateFormatParserTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetDateFormat() {
    ...
    varDateFormatParser.setDateFormat((java.text.DateFormat)null);
    assertEquals((java.text.DateFormat)null, varDateFormatParser.getDateFormat());
...
} // end of DateFormatParserTestCase
