 ...
 *
 * $Id: SampleData4TestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>SampleData4TestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.SampleData4TestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class SampleData4TestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected SampleData4 varSampleData4;

  /**
   * Public constructor for creating testing class.
   */
  public SampleData4TestCase (String name)
  {
    super (name);
  } // end of SampleData4TestCase(String name)
  ...
  {
    varSampleData4 = new SampleData4 ();
  } // end of setUp()
  ...
  {
    return new TestSuite (SampleData4TestCase.class);
  } // end of suite()
