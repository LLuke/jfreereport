...
public class LineShapeElementTestCase extends TestCase
{
  ...
  public void testDraw320600891290237458 ()
  {
    try
    {
      varLineShapeElement.setLine(new Line2D.Float (0,0, 10, 10));
      varLineShapeElement.setStroke(new BasicStroke (1));

      G2OutputTarget g2target = new G2OutputTarget(G2OutputTarget.createEmptyGraphics(), new PageFormat());
      varLineShapeElement.draw(g2target, new ItemBand());
    }
    catch (Exception e)
    {
    }
