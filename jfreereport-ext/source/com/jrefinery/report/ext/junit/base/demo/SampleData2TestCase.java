 ...
 *
 * $Id: SampleData2TestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>SampleData2TestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.SampleData2TestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class SampleData2TestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected SampleData2 varSampleData2;

  /**
   * Public constructor for creating testing class.
   */
  public SampleData2TestCase (String name)
  {
    super (name);
  } // end of SampleData2TestCase(String name)
  ...
  {
    varSampleData2 = new SampleData2 ();
  } // end of setUp()
  ...
  {
    return new TestSuite (SampleData2TestCase.class);
  } // end of suite()
