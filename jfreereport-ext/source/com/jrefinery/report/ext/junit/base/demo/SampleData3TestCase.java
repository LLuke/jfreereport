 ...
 *
 * $Id: SampleData3TestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>SampleData3TestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.SampleData3TestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class SampleData3TestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected SampleData3 varSampleData3;

  /**
   * Public constructor for creating testing class.
   */
  public SampleData3TestCase (String name)
  {
    super (name);
  } // end of SampleData3TestCase(String name)
  ...
  {
    varSampleData3 = new SampleData3 ();
  } // end of setUp()
  ...
  {
    return new TestSuite (SampleData3TestCase.class);
  } // end of suite()
