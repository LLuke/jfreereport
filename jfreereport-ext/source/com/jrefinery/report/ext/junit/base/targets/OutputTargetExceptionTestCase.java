...
/**
 * File <code>OutputTargetExceptionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.targets.OutputTargetExceptionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class OutputTargetExceptionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected OutputTargetException varOutputTargetException;

  /**
   * Public constructor for creating testing class.
   */
  public OutputTargetExceptionTestCase(String name) {
    super(name);
  } // end of OutputTargetExceptionTestCase(String name)
  /**
  ...
  protected void setUp() {
    ...
    // for example:
    // varOutputTargetException = new OutputTargetException(...);
    // But note that there is no default constructor in OutputTargetException
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(OutputTargetExceptionTestCase.class);
  } // end of suite()
  /**
  ...
  } // end of testGetParent()

} // end of OutputTargetExceptionTestCase
