 ...
 *
 * $Id: GroupHeaderTestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>GroupHeaderTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.GroupHeaderTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class GroupHeaderTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected GroupHeader varGroupHeader;

  /**
   * Public constructor for creating testing class.
   */
  public GroupHeaderTestCase(String name) {
    super(name);
  } // end of GroupHeaderTestCase(String name)
  /**
  ...
  protected void setUp() {
    varGroupHeader = new GroupHeader();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(GroupHeaderTestCase.class);
  } // end of suite()
  /**
   ...
   * from tested class
   */
  public void testHasPageBreakBeforePrint() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testHasPageBreakBeforePrint()

  /**
   * Method for testing how works original method:
   * void setPageBreakBeforePrint(boolean)
   * from tested class
   */
  public void testSetPageBreakBeforePrint64711720() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testSetPageBreakBeforePrint64711720(boolean)

} // end of GroupHeaderTestCase
