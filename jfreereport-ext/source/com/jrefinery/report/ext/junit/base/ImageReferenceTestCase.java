...
/**
 * File <code>ImageReferenceTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.ImageReferenceTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ImageReferenceTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ImageReference varImageReference;

  /**
   * Public constructor for creating testing class.
   */
  public ImageReferenceTestCase(String name) {
    super(name);
  } // end of ImageReferenceTestCase(String name)
  /**
  ...
  protected void setUp() {
    ...
    // for example:
    // varImageReference = new ImageReference(...);
    // But note that there is no default constructor in ImageReference
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ImageReferenceTestCase.class);
  } // end of suite()
  /**
  ...
  } // end of testEquals1063877011(java.lang.Object)
...
/* No default constructor, code commented out...
    varImageReference.setSourceURL((java.net.URL)null);
    assertEquals((java.net.URL)null, varImageReference.getSourceURL());
*/
    assertTrue("Warning! This new test method with no real test code inside.", false);
/* No default constructor, code commented out...
    varImageReference.setSourceURL((java.net.URL)null);
...
*/
  ...
  } // end of testGetSourceURL()

  /**
   * Method for testing how works original method:
   * void setSourceURL(java.net.URL)
   * from tested class
   */
  public void testSetSourceURL2050244018() {
...
*/
  ...
  } // end of testSetSourceURL2050244018(java.net.URL)
