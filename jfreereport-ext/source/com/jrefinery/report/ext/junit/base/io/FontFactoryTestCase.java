 ...
 *
 * $Id: FontFactoryTestCase.java,v 1.1 2002/07/08 22:10:38 taqua Exp $
 * $Author: taqua $
...
import com.jrefinery.report.io.FontFactory;

/**
 * File <code>FontFactoryTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.io.FontFactoryTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class FontFactoryTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected FontFactory varFontFactory;

  /**
   * Public constructor for creating testing class.
   */
  public FontFactoryTestCase(String name) {
    super(name);
  } // end of FontFactoryTestCase(String name)
  /**
  ...
  protected void setUp() {
    varFontFactory = new FontFactory();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(FontFactoryTestCase.class);
  } // end of suite()
  /**
   ...
   * java.awt.Font createDefaultFont(org.xml.sax.Attributes)
   * from tested class
   */
  public void testCreateDefaultFont1541113860() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testCreateDefaultFont1541113860(org.xml.sax.Attributes)

  /**
   * Method for testing how works original method:
   * java.awt.Font createFont(org.xml.sax.Attributes)
   * from tested class
   */
  public void testCreateFont1541113860() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testCreateFont1541113860(org.xml.sax.Attributes)
   ...
   * from tested class
   */
  public void testReadInt15411138601195259493104431() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testReadInt15411138601195259493104431( ... )

  /**
   * Method for testing how works original method:
   * int readSimpleFontStyle(org.xml.sax.Attributes, int)
   * from tested class
   */
  public void testReadSimpleFontStyle1541113860104431() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testReadSimpleFontStyle1541113860104431(org.xml.sax.Attributes, int)

} // end of FontFactoryTestCase
