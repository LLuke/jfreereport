 ...
 *
 * $Id: ImageLoadFilterTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>ImageLoadFilterTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.ImageLoadFilterTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ImageLoadFilterTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ImageLoadFilter varImageLoadFilter;

  /**
   * Public constructor for creating testing class.
   */
  public ImageLoadFilterTestCase(String name) {
    super(name);
  } // end of ImageLoadFilterTestCase(String name)
  /**
  ...
  protected void setUp() {
    varImageLoadFilter = new ImageLoadFilter();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ImageLoadFilterTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetDataSource() {
    ...
    varImageLoadFilter.setDataSource((com.jrefinery.report.filter.DataSource)null);
    assertEquals((com.jrefinery.report.filter.DataSource)null, varImageLoadFilter.getDataSource());
...
} // end of ImageLoadFilterTestCase
