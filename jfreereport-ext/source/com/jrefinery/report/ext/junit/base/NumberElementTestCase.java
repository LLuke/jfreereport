 ...
 *
 * $Id: NumberElementTestCase.java,v 1.3 2002/07/15 21:20:19 taqua Exp $
 * $Author: taqua $
...
public class NumberElementTestCase extends TestCase
{
  ...
  public void testGetFormatter () throws Exception
  {
    ...
    assertEquals (((NumberElement) varNumberElement.clone()).getFormatter(), format);
  ...
  public void testSetDecimalFormatString1195259493 ()
  {
    ...
    assertEquals(varNumberElement.getFormatter().format(0), fo.format (0));
