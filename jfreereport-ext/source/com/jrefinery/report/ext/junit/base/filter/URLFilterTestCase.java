 ...
 *
 * $Id: URLFilterTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>URLFilterTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.URLFilterTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class URLFilterTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected URLFilter varURLFilter;

  /**
   * Public constructor for creating testing class.
   */
  public URLFilterTestCase(String name) {
    super(name);
  } // end of URLFilterTestCase(String name)
  /**
  ...
  public static Test suite() {
    return new TestSuite(URLFilterTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetBaseURL() {
    ...
    varURLFilter.setBaseURL((java.net.URL)null);
    assertEquals((java.net.URL)null, varURLFilter.getBaseURL());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varURLFilter.setBaseURL((java.net.URL)null);
    assertEquals((java.net.URL)null, varURLFilter.getBaseURL());

  } // end of testGetBaseURL()
  ...
  public void testGetDataSource() {
    ...
    varURLFilter.setDataSource((com.jrefinery.report.filter.DataSource)null);
    assertEquals((com.jrefinery.report.filter.DataSource)null, varURLFilter.getDataSource());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varURLFilter.setDataSource((com.jrefinery.report.filter.DataSource)null);
    assertEquals((com.jrefinery.report.filter.DataSource)null, varURLFilter.getDataSource());
  ...
  /**
   * Method for testing how works original method:
   * void setBaseURL(java.net.URL)
   * from tested class
   */
  public void testSetBaseURL2050244018() {
  ...
  } // end of testSetBaseURL2050244018(java.net.URL)
