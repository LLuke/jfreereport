 ...
 *
 * $Id: TotalGroupSumFunctionTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
import com.jrefinery.report.function.TotalGroupSumFunction;

/**
 * File <code>TotalGroupSumFunctionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.function.TotalGroupSumFunctionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class TotalGroupSumFunctionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected TotalGroupSumFunction varTotalGroupSumFunction;

  /**
   * Public constructor for creating testing class.
   */
  public TotalGroupSumFunctionTestCase(String name) {
    super(name);
  } // end of TotalGroupSumFunctionTestCase(String name)
  /**
  ...
  protected void setUp() {
    varTotalGroupSumFunction = new TotalGroupSumFunction();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(TotalGroupSumFunctionTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetField() {
    ...
    varTotalGroupSumFunction.setField((String)null);
    assertEquals((String)null, varTotalGroupSumFunction.getField());
    varTotalGroupSumFunction.setField((String)"");
    assertEquals((String)"", varTotalGroupSumFunction.getField());
    varTotalGroupSumFunction.setField((String)"\u0000");
    assertEquals((String)"\u0000", varTotalGroupSumFunction.getField());
    varTotalGroupSumFunction.setField((String)" ");
    assertEquals((String)" ", varTotalGroupSumFunction.getField());
    varTotalGroupSumFunction.setField((String)"\n");
    assertEquals((String)"\n", varTotalGroupSumFunction.getField());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varTotalGroupSumFunction.setField((String)null);
    assertEquals((String)null, varTotalGroupSumFunction.getField());
    varTotalGroupSumFunction.setField((String)"");
  ...
  public void testGetGroup() {
    ...
    varTotalGroupSumFunction.setGroup((String)null);
    assertEquals((String)null, varTotalGroupSumFunction.getGroup());
    varTotalGroupSumFunction.setGroup((String)"");
    assertEquals((String)"", varTotalGroupSumFunction.getGroup());
    varTotalGroupSumFunction.setGroup((String)"\u0000");
    assertEquals((String)"\u0000", varTotalGroupSumFunction.getGroup());
    varTotalGroupSumFunction.setGroup((String)" ");
    assertEquals((String)" ", varTotalGroupSumFunction.getGroup());
    varTotalGroupSumFunction.setGroup((String)"\n");
    assertEquals((String)"\n", varTotalGroupSumFunction.getGroup());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varTotalGroupSumFunction.setGroup((String)null);
    assertEquals((String)null, varTotalGroupSumFunction.getGroup());
    varTotalGroupSumFunction.setGroup((String)"");
...
} // end of TotalGroupSumFunctionTestCase
