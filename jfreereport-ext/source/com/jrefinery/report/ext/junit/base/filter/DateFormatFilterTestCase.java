 ...
 *
 * $Id: DateFormatFilterTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>DateFormatFilterTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.DateFormatFilterTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class DateFormatFilterTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected DateFormatFilter varDateFormatFilter;

  /**
   * Public constructor for creating testing class.
   */
  public DateFormatFilterTestCase(String name) {
    super(name);
  } // end of DateFormatFilterTestCase(String name)
  /**
  ...
  protected void setUp() {
    varDateFormatFilter = new DateFormatFilter();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(DateFormatFilterTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetDateFormat() {
    ...
    varDateFormatFilter.setDateFormat((java.text.DateFormat)null);
    assertEquals((java.text.DateFormat)null, varDateFormatFilter.getDateFormat());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varDateFormatFilter.setDateFormat((java.text.DateFormat)null);
    assertEquals((java.text.DateFormat)null, varDateFormatFilter.getDateFormat());

  } // end of testGetDateFormat()
   ...
   * from tested class
   */
  public void testSetDateFormat379288326() {
  ...
  } // end of testSetDateFormat379288326(java.text.DateFormat)
...
} // end of DateFormatFilterTestCase
