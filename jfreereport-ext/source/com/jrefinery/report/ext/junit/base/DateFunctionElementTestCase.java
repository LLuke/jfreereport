 ...
 *
 * $Id: DateFunctionElementTestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>DateFunctionElementTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.DateFunctionElementTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class DateFunctionElementTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected DateFunctionElement varDateFunctionElement;

  /**
   * Public constructor for creating testing class.
   */
  public DateFunctionElementTestCase(String name) {
    super(name);
  } // end of DateFunctionElementTestCase(String name)
  /**
  ...
  protected void setUp() {
    varDateFunctionElement = new DateFunctionElement();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(DateFunctionElementTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetFormatter() {
    ...
    varDateFunctionElement.setFormatter((java.text.DateFormat)null);
    assertEquals((java.text.DateFormat)null, varDateFunctionElement.getFormatter());
  ...
  /**
   * Method for testing how works original method:
   * void setFormatter(java.text.DateFormat)
   * from tested class
   */
  public void testSetFormatter379288326() {
  ...
  } // end of testSetFormatter379288326(java.text.DateFormat)

} // end of DateFunctionElementTestCase
