 ...
 *
 * $Id: FunctionDataSourceTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>FunctionDataSourceTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.FunctionDataSourceTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class FunctionDataSourceTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected FunctionDataSource varFunctionDataSource;

  /**
   * Public constructor for creating testing class.
   */
  public FunctionDataSourceTestCase(String name) {
    super(name);
  } // end of FunctionDataSourceTestCase(String name)
  /**
  ...
  protected void setUp() {
    varFunctionDataSource = new FunctionDataSource();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(FunctionDataSourceTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetFunction() {
    ...
    varFunctionDataSource.setFunction((String)null);
    assertEquals((String)null, varFunctionDataSource.getFunction());
    varFunctionDataSource.setFunction((String)"");
    assertEquals((String)"", varFunctionDataSource.getFunction());
    varFunctionDataSource.setFunction((String)"\u0000");
    assertEquals((String)"\u0000", varFunctionDataSource.getFunction());
    varFunctionDataSource.setFunction((String)" ");
    assertEquals((String)" ", varFunctionDataSource.getFunction());
    varFunctionDataSource.setFunction((String)"\n");
    assertEquals((String)"\n", varFunctionDataSource.getFunction());
  ...
  public void testGetValue() {
    ...
    varFunctionDataSource.setValue((Object)null);
    assertEquals((Object)null, varFunctionDataSource.getValue());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varFunctionDataSource.setValue((Object)null);
    assertEquals((Object)null, varFunctionDataSource.getValue());
   ...
   * from tested class
   */
  public void testSetFunction1195259493() {
  ...
  } // end of testSetFunction1195259493(java.lang.String)
...
} // end of FunctionDataSourceTestCase
