 ...
 *
 * $Id: SimpleDateFormatParserTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>SimpleDateFormatParserTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.SimpleDateFormatParserTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class SimpleDateFormatParserTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected SimpleDateFormatParser varSimpleDateFormatParser;

  /**
   * Public constructor for creating testing class.
   */
  public SimpleDateFormatParserTestCase(String name) {
    super(name);
  } // end of SimpleDateFormatParserTestCase(String name)
  /**
  ...
  protected void setUp() {
    varSimpleDateFormatParser = new SimpleDateFormatParser();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(SimpleDateFormatParserTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetFormatString() {
    ...
    varSimpleDateFormatParser.setFormatString((String)null);
    assertEquals((String)null, varSimpleDateFormatParser.getFormatString());
    varSimpleDateFormatParser.setFormatString((String)"");
    assertEquals((String)"", varSimpleDateFormatParser.getFormatString());
    varSimpleDateFormatParser.setFormatString((String)"\u0000");
    assertEquals((String)"\u0000", varSimpleDateFormatParser.getFormatString());
    varSimpleDateFormatParser.setFormatString((String)" ");
    assertEquals((String)" ", varSimpleDateFormatParser.getFormatString());
    varSimpleDateFormatParser.setFormatString((String)"\n");
    assertEquals((String)"\n", varSimpleDateFormatParser.getFormatString());
  ...
  public void testGetLocalizedFormatString() {
    ...
    varSimpleDateFormatParser.setLocalizedFormatString((String)null);
    assertEquals((String)null, varSimpleDateFormatParser.getLocalizedFormatString());
    varSimpleDateFormatParser.setLocalizedFormatString((String)"");
    assertEquals((String)"", varSimpleDateFormatParser.getLocalizedFormatString());
    varSimpleDateFormatParser.setLocalizedFormatString((String)"\u0000");
    assertEquals((String)"\u0000", varSimpleDateFormatParser.getLocalizedFormatString());
    varSimpleDateFormatParser.setLocalizedFormatString((String)" ");
    assertEquals((String)" ", varSimpleDateFormatParser.getLocalizedFormatString());
    varSimpleDateFormatParser.setLocalizedFormatString((String)"\n");
    assertEquals((String)"\n", varSimpleDateFormatParser.getLocalizedFormatString());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varSimpleDateFormatParser.setLocalizedFormatString((String)null);
    assertEquals((String)null, varSimpleDateFormatParser.getLocalizedFormatString());
    varSimpleDateFormatParser.setLocalizedFormatString((String)"");
  ...
  public void testGetSimpleDateFormat() {
    ...
    varSimpleDateFormatParser.setSimpleDateFormat((java.text.SimpleDateFormat)null);
    assertEquals((java.text.SimpleDateFormat)null, varSimpleDateFormatParser.getSimpleDateFormat());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varSimpleDateFormatParser.setSimpleDateFormat((java.text.SimpleDateFormat)null);
    assertEquals((java.text.SimpleDateFormat)null, varSimpleDateFormatParser.getSimpleDateFormat());
...
} // end of SimpleDateFormatParserTestCase
