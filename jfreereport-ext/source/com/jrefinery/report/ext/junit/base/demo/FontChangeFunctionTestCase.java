 ...
 *
 * $Id: FontChangeFunctionTestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
 * $Date: 2002/07/08 22:10:35 $
 */
package com.jrefinery.report.ext.junit.base.demo;

import com.jrefinery.report.demo.FontChangeFunction;
...
/**
 * File <code>FontChangeFunctionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.FontChangeFunctionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class FontChangeFunctionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected FontChangeFunction varFontChangeFunction;

  /**
   * Public constructor for creating testing class.
   */
  public FontChangeFunctionTestCase (String name)
  {
    super (name);
  } // end of FontChangeFunctionTestCase(String name)
  ...
  {
    varFontChangeFunction = new FontChangeFunction ();
  } // end of setUp()
  ...
  {
    return new TestSuite (FontChangeFunctionTestCase.class);
  } // end of suite()
  ...
  public void testGetElement ()
  {
    ...
    varFontChangeFunction.setElement ((String) null);
    assertEquals ((String) null, varFontChangeFunction.getElement ());
    varFontChangeFunction.setElement ((String) "");
    assertEquals ((String) "", varFontChangeFunction.getElement ());
    varFontChangeFunction.setElement ((String) "\u0000");
    assertEquals ((String) "\u0000", varFontChangeFunction.getElement ());
    varFontChangeFunction.setElement ((String) " ");
    assertEquals ((String) " ", varFontChangeFunction.getElement ());
    varFontChangeFunction.setElement ((String) "\n");
    assertEquals ((String) "\n", varFontChangeFunction.getElement ());
...
} // end of FontChangeFunctionTestCase
