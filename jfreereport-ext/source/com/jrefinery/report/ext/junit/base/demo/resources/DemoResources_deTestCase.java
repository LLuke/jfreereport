 ...
 *
 * $Id: DemoResources_deTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
 * $Date: 2002/07/08 22:10:36 $
 */
package com.jrefinery.report.ext.junit.base.demo.resources;

import com.jrefinery.report.demo.resources.DemoResources_de;
...
/**
 * File <code>DemoResources_deTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.resources.DemoResources_deTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class DemoResources_deTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected DemoResources_de varDemoResources_de;

  /**
   * Public constructor for creating testing class.
   */
  public DemoResources_deTestCase (String name)
  {
    super (name);
  } // end of DemoResources_deTestCase(String name)
  ...
  {
    varDemoResources_de = new DemoResources_de ();
  } // end of setUp()
  ...
  {
    return new TestSuite (DemoResources_deTestCase.class);
  } // end of suite()
...
} // end of DemoResources_deTestCase
