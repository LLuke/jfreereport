...
/**
 * File <code>ElementVisibilitySwitchFunctionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.function.ElementVisibilitySwitchFunctionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ElementVisibilitySwitchFunctionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ElementVisibilitySwitchFunction varElementVisibilitySwitchFunction;

  /**
   * Public constructor for creating testing class.
   */
  public ElementVisibilitySwitchFunctionTestCase(String name) {
    super(name);
  } // end of ElementVisibilitySwitchFunctionTestCase(String name)
  /**
  ...
  public static Test suite() {
    return new TestSuite(ElementVisibilitySwitchFunctionTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetElement() {
    ...
    varElementVisibilitySwitchFunction.setElement((String)null);
    assertEquals((String)null, varElementVisibilitySwitchFunction.getElement());
    varElementVisibilitySwitchFunction.setElement((String)"");
    assertEquals((String)"", varElementVisibilitySwitchFunction.getElement());
    varElementVisibilitySwitchFunction.setElement((String)"\u0000");
    assertEquals((String)"\u0000", varElementVisibilitySwitchFunction.getElement());
    varElementVisibilitySwitchFunction.setElement((String)" ");
    assertEquals((String)" ", varElementVisibilitySwitchFunction.getElement());
    varElementVisibilitySwitchFunction.setElement((String)"\n");
    assertEquals((String)"\n", varElementVisibilitySwitchFunction.getElement());
   ...
   * from tested class
   */
  public void testSetElement1195259493() {
  ...
  } // end of testSetElement1195259493(java.lang.String)

} // end of ElementVisibilitySwitchFunctionTestCase
