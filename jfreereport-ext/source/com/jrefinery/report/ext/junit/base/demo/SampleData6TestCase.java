 ...
 *
 * $Id: SampleData6TestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
 * $Date: 2002/07/08 22:10:36 $
 */
package com.jrefinery.report.ext.junit.base.demo;

import com.jrefinery.report.demo.SampleData6;
...
/**
 * File <code>SampleData6TestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.SampleData6TestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class SampleData6TestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected SampleData6 varSampleData6;

  /**
   * Public constructor for creating testing class.
   */
  public SampleData6TestCase (String name)
  {
    super (name);
  } // end of SampleData6TestCase(String name)
  ...
  {
    varSampleData6 = new SampleData6 ();
  } // end of setUp()
  ...
  {
    return new TestSuite (SampleData6TestCase.class);
  } // end of suite()
  ...
  /**
   * Method for testing how works original method:
   * java.lang.Class getColumnClass(int)
   * from tested class
   */
  public void testGetColumnClass104431 ()
  {

    assertTrue ("Warning! This new test method with no real test code inside.", false);

  } // end of testGetColumnClass104431(int)
   ...
   * from tested class
   */
  public void testGetColumnName104431 ()
  {

    assertTrue ("Warning! This new test method with no real test code inside.", false);

  } // end of testGetColumnName104431(int)
  ...
  } // end of testGetRowCount()

  /**
   * Method for testing how works original method:
   * java.lang.Object getValueAt(int, int)
   * from tested class
   */
  public void testGetValueAt104431104431 ()
  {

    assertTrue ("Warning! This new test method with no real test code inside.", false);

  } // end of testGetValueAt104431104431(int, int)

} // end of SampleData6TestCase
