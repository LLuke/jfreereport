 ...
 *
 * $Id: ItemCountFunctionTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>ItemCountFunctionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.function.ItemCountFunctionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ItemCountFunctionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ItemCountFunction varItemCountFunction;

  /**
   * Public constructor for creating testing class.
   */
  public ItemCountFunctionTestCase(String name) {
    super(name);
  } // end of ItemCountFunctionTestCase(String name)
  /**
  ...
  protected void setUp() {
    varItemCountFunction = new ItemCountFunction();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ItemCountFunctionTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetGroup() {
    ...
    varItemCountFunction.setGroup((String)null);
    assertEquals((String)null, varItemCountFunction.getGroup());
    varItemCountFunction.setGroup((String)"");
    assertEquals((String)"", varItemCountFunction.getGroup());
    varItemCountFunction.setGroup((String)"\u0000");
    assertEquals((String)"\u0000", varItemCountFunction.getGroup());
    varItemCountFunction.setGroup((String)" ");
    assertEquals((String)" ", varItemCountFunction.getGroup());
    varItemCountFunction.setGroup((String)"\n");
    assertEquals((String)"\n", varItemCountFunction.getGroup());
...
} // end of ItemCountFunctionTestCase
