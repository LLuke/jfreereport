 ...
 *
 * $Id: PageHeaderTestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>PageHeaderTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.PageHeaderTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class PageHeaderTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected PageHeader varPageHeader;

  /**
   * Public constructor for creating testing class.
   */
  public PageHeaderTestCase(String name) {
    super(name);
  } // end of PageHeaderTestCase(String name)
  /**
  ...
  public static Test suite() {
    return new TestSuite(PageHeaderTestCase.class);
  } // end of suite()

  /**
   * Method for testing how works original method:
   * void setDisplayOnFirstPage(boolean)
   * from tested class
   */
  public void testSetDisplayOnFirstPage64711720() {

    varPageHeader.setDisplayOnFirstPage(true);
    assertTrue(varPageHeader.isDisplayOnFirstPage());

    varPageHeader.setDisplayOnFirstPage(false);
    assertTrue(varPageHeader.isDisplayOnFirstPage() == false);

  } // end of testSetDisplayOnFirstPage64711720(boolean)

  /**
   * Method for testing how works original method:
   * void setDisplayOnLastPage(boolean)
   * from tested class
   */
  public void testSetDisplayOnLastPage64711720() {

    varPageHeader.setDisplayOnLastPage(true);
    assertTrue(varPageHeader.isDisplayOnLastPage());

    varPageHeader.setDisplayOnLastPage(false);
    assertTrue(varPageHeader.isDisplayOnLastPage() == false);

  } // end of testSetDisplayOnLastPage64711720(boolean)

} // end of PageHeaderTestCase
