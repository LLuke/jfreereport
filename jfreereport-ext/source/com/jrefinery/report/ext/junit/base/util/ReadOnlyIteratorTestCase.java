...
/**
 * File <code>ReadOnlyIteratorTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.util.ReadOnlyIteratorTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ReadOnlyIteratorTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ReadOnlyIterator varReadOnlyIterator;

  /**
   * Public constructor for creating testing class.
   */
  public ReadOnlyIteratorTestCase(String name) {
    super(name);
  } // end of ReadOnlyIteratorTestCase(String name)
  /**
  ...
  protected void setUp() {
    ...
    // for example:
    // varReadOnlyIterator = new ReadOnlyIterator(...);
    // But note that there is no default constructor in ReadOnlyIterator
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ReadOnlyIteratorTestCase.class);
  } // end of suite()
  /**
...
} // end of ReadOnlyIteratorTestCase
