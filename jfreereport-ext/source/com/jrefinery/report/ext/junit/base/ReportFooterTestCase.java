 ...
 *
 * $Id: ReportFooterTestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>ReportFooterTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.ReportFooterTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ReportFooterTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ReportFooter varReportFooter;

  /**
   * Public constructor for creating testing class.
   */
  public ReportFooterTestCase(String name) {
    super(name);
  } // end of ReportFooterTestCase(String name)
  /**
  ...
  protected void setUp() {
    varReportFooter = new ReportFooter();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ReportFooterTestCase.class);
  } // end of suite()
  ...
  public void testIsOwnPage() {
    ...
    varReportFooter.setOwnPage(true);
    assertTrue(varReportFooter.isOwnPage());

    varReportFooter.setOwnPage(false);
    assertTrue(varReportFooter.isOwnPage() == false);

  } // end of testIsOwnPage()


} // end of ReportFooterTestCase
