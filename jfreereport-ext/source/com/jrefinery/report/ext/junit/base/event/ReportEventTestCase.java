...
/**
 * File <code>ReportEventTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.event.ReportEventTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ReportEventTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ReportEvent varReportEvent;

  /**
   * Public constructor for creating testing class.
   */
  public ReportEventTestCase(String name) {
    super(name);
  } // end of ReportEventTestCase(String name)
  /**
  ...
  protected void setUp() {
    ...
    // for example:
    // varReportEvent = new ReportEvent(...);
    // But note that there is no default constructor in ReportEvent
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ReportEventTestCase.class);
  } // end of suite()
  /**
  ...
  /**
   * Method for testing how works original method:
   * com.jrefinery.report.ReportState getState()
   * from tested class
   */
