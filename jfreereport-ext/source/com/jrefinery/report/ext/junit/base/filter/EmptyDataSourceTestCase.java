 ...
 *
 * $Id: EmptyDataSourceTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>EmptyDataSourceTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.EmptyDataSourceTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class EmptyDataSourceTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected EmptyDataSource varEmptyDataSource;

  /**
   * Public constructor for creating testing class.
   */
  public EmptyDataSourceTestCase(String name) {
    super(name);
  } // end of EmptyDataSourceTestCase(String name)
  /**
  ...
  protected void setUp() {
    varEmptyDataSource = new EmptyDataSource();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(EmptyDataSourceTestCase.class);
  } // end of suite()
  /**
...
} // end of EmptyDataSourceTestCase
