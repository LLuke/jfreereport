 ...
 *
 * $Id: DecimalFormatParserTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>DecimalFormatParserTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.DecimalFormatParserTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class DecimalFormatParserTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected DecimalFormatParser varDecimalFormatParser;

  /**
   * Public constructor for creating testing class.
   */
  public DecimalFormatParserTestCase(String name) {
    super(name);
  } // end of DecimalFormatParserTestCase(String name)
  /**
  ...
  protected void setUp() {
    varDecimalFormatParser = new DecimalFormatParser();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(DecimalFormatParserTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetDecimalFormat() {
    ...
    varDecimalFormatParser.setDecimalFormat((java.text.DecimalFormat)null);
    assertEquals((java.text.DecimalFormat)null, varDecimalFormatParser.getDecimalFormat());
  ...
  public void testGetFormatString() {
    ...
    varDecimalFormatParser.setFormatString((String)null);
    assertEquals((String)null, varDecimalFormatParser.getFormatString());
    varDecimalFormatParser.setFormatString((String)"");
    assertEquals((String)"", varDecimalFormatParser.getFormatString());
    varDecimalFormatParser.setFormatString((String)"\u0000");
    assertEquals((String)"\u0000", varDecimalFormatParser.getFormatString());
    varDecimalFormatParser.setFormatString((String)" ");
    assertEquals((String)" ", varDecimalFormatParser.getFormatString());
    varDecimalFormatParser.setFormatString((String)"\n");
    assertEquals((String)"\n", varDecimalFormatParser.getFormatString());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varDecimalFormatParser.setFormatString((String)null);
    assertEquals((String)null, varDecimalFormatParser.getFormatString());
    varDecimalFormatParser.setFormatString((String)"");
  ...
  public void testGetLocalizedFormatString() {
    ...
    varDecimalFormatParser.setLocalizedFormatString((String)null);
    assertEquals((String)null, varDecimalFormatParser.getLocalizedFormatString());
    varDecimalFormatParser.setLocalizedFormatString((String)"");
    assertEquals((String)"", varDecimalFormatParser.getLocalizedFormatString());
    varDecimalFormatParser.setLocalizedFormatString((String)"\u0000");
    assertEquals((String)"\u0000", varDecimalFormatParser.getLocalizedFormatString());
    varDecimalFormatParser.setLocalizedFormatString((String)" ");
    assertEquals((String)" ", varDecimalFormatParser.getLocalizedFormatString());
    varDecimalFormatParser.setLocalizedFormatString((String)"\n");
    assertEquals((String)"\n", varDecimalFormatParser.getLocalizedFormatString());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varDecimalFormatParser.setLocalizedFormatString((String)null);
    assertEquals((String)null, varDecimalFormatParser.getLocalizedFormatString());
    varDecimalFormatParser.setLocalizedFormatString((String)"");
...
} // end of DecimalFormatParserTestCase
