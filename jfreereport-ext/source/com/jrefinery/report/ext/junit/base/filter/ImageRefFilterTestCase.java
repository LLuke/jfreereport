 ...
 *
 * $Id: ImageRefFilterTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>ImageRefFilterTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.ImageRefFilterTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ImageRefFilterTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ImageRefFilter varImageRefFilter;

  /**
   * Public constructor for creating testing class.
   */
  public ImageRefFilterTestCase(String name) {
    super(name);
  } // end of ImageRefFilterTestCase(String name)
  /**
  ...
  protected void setUp() {
    varImageRefFilter = new ImageRefFilter();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ImageRefFilterTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetDataSource() {
    ...
    varImageRefFilter.setDataSource((com.jrefinery.report.filter.DataSource)null);
    assertEquals((com.jrefinery.report.filter.DataSource)null, varImageRefFilter.getDataSource());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varImageRefFilter.setDataSource((com.jrefinery.report.filter.DataSource)null);
    assertEquals((com.jrefinery.report.filter.DataSource)null, varImageRefFilter.getDataSource());
