 ...
 *
 * $Id: StringFilterTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>StringFilterTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.StringFilterTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class StringFilterTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected StringFilter varStringFilter;

  /**
   * Public constructor for creating testing class.
   */
  public StringFilterTestCase(String name) {
    super(name);
  } // end of StringFilterTestCase(String name)
  /**
  ...
  protected void setUp() {
    varStringFilter = new StringFilter();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(StringFilterTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetDataSource() {
    ...
    varStringFilter.setDataSource((com.jrefinery.report.filter.DataSource)null);
    assertEquals((com.jrefinery.report.filter.DataSource)null, varStringFilter.getDataSource());
  ...
  public void testGetNullValue() {
    ...
    varStringFilter.setNullValue((String)null);
    assertEquals((String)null, varStringFilter.getNullValue());
    varStringFilter.setNullValue((String)"");
    assertEquals((String)"", varStringFilter.getNullValue());
    varStringFilter.setNullValue((String)"\u0000");
    assertEquals((String)"\u0000", varStringFilter.getNullValue());
    varStringFilter.setNullValue((String)" ");
    assertEquals((String)" ", varStringFilter.getNullValue());
    varStringFilter.setNullValue((String)"\n");
    assertEquals((String)"\n", varStringFilter.getNullValue());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varStringFilter.setNullValue((String)null);
    assertEquals((String)null, varStringFilter.getNullValue());
    varStringFilter.setNullValue((String)"");
