 ...
 *
 * $Id: ItemPercentageFunctionTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
import com.jrefinery.report.function.ItemPercentageFunction;

/**
 * File <code>ItemPercentageFunctionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.function.ItemPercentageFunctionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ItemPercentageFunctionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ItemPercentageFunction varItemPercentageFunction;

  /**
   * Public constructor for creating testing class.
   */
  public ItemPercentageFunctionTestCase(String name) {
    super(name);
  } // end of ItemPercentageFunctionTestCase(String name)
  /**
  ...
  protected void setUp() {
    varItemPercentageFunction = new ItemPercentageFunction();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ItemPercentageFunctionTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetField() {
    ...
    varItemPercentageFunction.setField((String)null);
    assertEquals((String)null, varItemPercentageFunction.getField());
    varItemPercentageFunction.setField((String)"");
    assertEquals((String)"", varItemPercentageFunction.getField());
    varItemPercentageFunction.setField((String)"\u0000");
    assertEquals((String)"\u0000", varItemPercentageFunction.getField());
    varItemPercentageFunction.setField((String)" ");
    assertEquals((String)" ", varItemPercentageFunction.getField());
    varItemPercentageFunction.setField((String)"\n");
    assertEquals((String)"\n", varItemPercentageFunction.getField());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varItemPercentageFunction.setField((String)null);
    assertEquals((String)null, varItemPercentageFunction.getField());
    varItemPercentageFunction.setField((String)"");
  ...
  public void testGetGroup() {
    ...
    varItemPercentageFunction.setGroup((String)null);
    assertEquals((String)null, varItemPercentageFunction.getGroup());
    varItemPercentageFunction.setGroup((String)"");
    assertEquals((String)"", varItemPercentageFunction.getGroup());
    varItemPercentageFunction.setGroup((String)"\u0000");
    assertEquals((String)"\u0000", varItemPercentageFunction.getGroup());
    varItemPercentageFunction.setGroup((String)" ");
    assertEquals((String)" ", varItemPercentageFunction.getGroup());
    varItemPercentageFunction.setGroup((String)"\n");
    assertEquals((String)"\n", varItemPercentageFunction.getGroup());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varItemPercentageFunction.setGroup((String)null);
    assertEquals((String)null, varItemPercentageFunction.getGroup());
    varItemPercentageFunction.setGroup((String)"");
   ...
   * from tested class
   */
  public void testSetProperty11952594931195259493() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testSetProperty11952594931195259493(java.lang.String, java.lang.String)

} // end of ItemPercentageFunctionTestCase
