...
import com.jrefinery.report.io.BandFactory;

/**
 * File <code>BandFactoryTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.io.BandFactoryTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class BandFactoryTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected BandFactory varBandFactory;

  /**
   * Public constructor for creating testing class.
   */
  public BandFactoryTestCase(String name) {
    super(name);
  } // end of BandFactoryTestCase(String name)
  /**
  ...
  protected void setUp() {
    ...
    // for example:
    // varBandFactory = new BandFactory(...);
    // But note that there is no default constructor in BandFactory
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(BandFactoryTestCase.class);
  } // end of suite()
  /**
   ...
   * from tested class
   */
  public void testEndPageFooter() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testEndPageFooter()
   ...
   * from tested class
   */
  public void testEndPageHeader() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testEndPageHeader()

  /**
   * Method for testing how works original method:
   * void endReportFooter()
   * from tested class
   */
  public void testEndReportFooter() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testEndReportFooter()

  /**
   * Method for testing how works original method:
   * void endReportHeader()
   * from tested class
   */
  public void testEndReportHeader() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testEndReportHeader()
...
/* No default constructor, code commented out...
    varBandFactory.setCurrentBand((com.jrefinery.report.Band)null);
    assertEquals((com.jrefinery.report.Band)null, varBandFactory.getCurrentBand());
*/
    assertTrue("Warning! This new test method with no real test code inside.", false);
/* No default constructor, code commented out...
    varBandFactory.setCurrentBand((com.jrefinery.report.Band)null);
...
*/
  ...
  /**
   * Method for testing how works original method:
   * void startItems(org.xml.sax.Attributes)
   * from tested class
   */
  public void testStartItems1541113860() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testStartItems1541113860(org.xml.sax.Attributes)

  /**
   * Method for testing how works original method:
   * void startPageFooter(org.xml.sax.Attributes)
   * from tested class
   */
  public void testStartPageFooter1541113860() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testStartPageFooter1541113860(org.xml.sax.Attributes)

  /**
   * Method for testing how works original method:
   * void startPageHeader(org.xml.sax.Attributes)
   * from tested class
   */
  public void testStartPageHeader1541113860() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testStartPageHeader1541113860(org.xml.sax.Attributes)

  /**
   * Method for testing how works original method:
   * void startReportFooter(org.xml.sax.Attributes)
   * from tested class
   */
  public void testStartReportFooter1541113860() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testStartReportFooter1541113860(org.xml.sax.Attributes)

  /**
   * Method for testing how works original method:
   * void startReportHeader(org.xml.sax.Attributes)
   * from tested class
   */
  public void testStartReportHeader1541113860() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testStartReportHeader1541113860(org.xml.sax.Attributes)

} // end of BandFactoryTestCase
