 ...
 *
 * $Id: SampleData1TestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>SampleData1TestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.SampleData1TestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class SampleData1TestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected SampleData1 varSampleData1;

  /**
   * Public constructor for creating testing class.
   */
  public SampleData1TestCase (String name)
  {
    super (name);
  } // end of SampleData1TestCase(String name)
  ...
  {
    varSampleData1 = new SampleData1 ();
  } // end of setUp()
  ...
  {
    return new TestSuite (SampleData1TestCase.class);
  } // end of suite()
