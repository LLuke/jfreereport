 ...
 *
 * $Id: FloatingButtonEnablerTestCase.java,v 1.1 2002/07/08 22:10:38 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>FloatingButtonEnablerTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.util.FloatingButtonEnablerTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class FloatingButtonEnablerTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected FloatingButtonEnabler varFloatingButtonEnabler;

  /**
   * Public constructor for creating testing class.
   */
  public FloatingButtonEnablerTestCase(String name) {
    super(name);
  } // end of FloatingButtonEnablerTestCase(String name)
  /**
  ...
  protected void setUp() {
    varFloatingButtonEnabler = FloatingButtonEnabler.getInstance();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(FloatingButtonEnablerTestCase.class);
  } // end of suite()
  /**
   ...
   * void addButton(javax.swing.AbstractButton)
   * from tested class
   */
  public void testAddButton1879508828() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testAddButton1879508828(javax.swing.AbstractButton)

  /**
   * Method for testing how works original method:
   * com.jrefinery.report.util.FloatingButtonEnabler getInstance()
   * from tested class
   */
   ...
   * from tested class
   */
  public void testMouseEntered2008307163() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testMouseEntered2008307163(java.awt.event.MouseEvent)
   ...
   * from tested class
   */
  public void testMouseExited2008307163() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testMouseExited2008307163(java.awt.event.MouseEvent)

  /**
   * Method for testing how works original method:
   * void removeButton(javax.swing.AbstractButton)
   * from tested class
   */
  public void testRemoveButton1879508828() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testRemoveButton1879508828(javax.swing.AbstractButton)

} // end of FloatingButtonEnablerTestCase
