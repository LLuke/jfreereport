...
/**
 * File <code>ReportDefinitionExceptionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.io.ReportDefinitionExceptionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ReportDefinitionExceptionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ReportDefinitionException varReportDefinitionException;

  /**
   * Public constructor for creating testing class.
   */
  public ReportDefinitionExceptionTestCase(String name) {
    super(name);
  } // end of ReportDefinitionExceptionTestCase(String name)
  /**
  ...
  protected void setUp() {
    ...
    // for example:
    // varReportDefinitionException = new ReportDefinitionException(...);
    // But note that there is no default constructor in ReportDefinitionException
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ReportDefinitionExceptionTestCase.class);
  } // end of suite()
  /**
  ...
  } // end of testGetParentException()

} // end of ReportDefinitionExceptionTestCase
