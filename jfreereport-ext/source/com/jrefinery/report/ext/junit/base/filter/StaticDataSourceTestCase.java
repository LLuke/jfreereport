 ...
 *
 * $Id: StaticDataSourceTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>StaticDataSourceTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.StaticDataSourceTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class StaticDataSourceTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected StaticDataSource varStaticDataSource;

  /**
   * Public constructor for creating testing class.
   */
  public StaticDataSourceTestCase(String name) {
    super(name);
  } // end of StaticDataSourceTestCase(String name)
  /**
  ...
  protected void setUp() {
    varStaticDataSource = new StaticDataSource();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(StaticDataSourceTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetValue() {
    ...
    varStaticDataSource.setValue((Object)null);
    assertEquals((Object)null, varStaticDataSource.getValue());
...
} // end of StaticDataSourceTestCase
