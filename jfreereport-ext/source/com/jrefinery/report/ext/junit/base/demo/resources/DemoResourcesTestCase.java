 ...
 *
 * $Id: DemoResourcesTestCase.java,v 1.1 2002/07/08 22:10:36 taqua Exp $
 * $Author: taqua $
 * $Date: 2002/07/08 22:10:36 $
 */
package com.jrefinery.report.ext.junit.base.demo.resources;

import com.jrefinery.report.demo.resources.DemoResources;
...
/**
 * File <code>DemoResourcesTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.demo.resources.DemoResourcesTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class DemoResourcesTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected DemoResources varDemoResources;

  /**
   * Public constructor for creating testing class.
   */
  public DemoResourcesTestCase (String name)
  {
    super (name);
  } // end of DemoResourcesTestCase(String name)
  ...
  {
    varDemoResources = new DemoResources ();
  } // end of setUp()
  ...
  {
    return new TestSuite (DemoResourcesTestCase.class);
  } // end of suite()
