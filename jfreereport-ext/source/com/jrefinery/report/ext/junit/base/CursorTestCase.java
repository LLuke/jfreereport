...
/**
 * File <code>CursorTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.CursorTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class CursorTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected Cursor varCursor;

  /**
   * Public constructor for creating testing class.
   */
  public CursorTestCase(String name) {
    super(name);
  } // end of CursorTestCase(String name)
  /**
  ...
  protected void setUp() {
    ...
    // for example:
    // varCursor = new Cursor(...);
    // But note that there is no default constructor in Cursor
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(CursorTestCase.class);
  } // end of suite()
  /**
   ...
   * from tested class
   */
  public void testAdvanceTo97526364() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testAdvanceTo97526364(float)
   ...
   * from tested class
   */
  public void testGetPageBottom() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testGetPageBottom()
   ...
   * from tested class
   */
  public void testGetPageLeft() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testGetPageLeft()
  ...
  /**
   * Method for testing how works original method:
   * boolean isSpaceFor(float)
   * from tested class
   */
  public void testIsSpaceFor97526364() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testIsSpaceFor97526364(float)

  /**
   * Method for testing how works original method:
   * void reserveSpace(float)
   * from tested class
   */
  public void testReserveSpace97526364() {

    assertTrue("Warning! This new test method with no real test code inside.", false);

  } // end of testReserveSpace97526364(float)

} // end of CursorTestCase
