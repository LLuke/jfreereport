 ...
 *
 * $Id: ReportPropertyFunctionTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>ReportPropertyFunctionTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.function.ReportPropertyFunctionTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class ReportPropertyFunctionTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected ReportPropertyFunction varReportPropertyFunction;

  /**
   * Public constructor for creating testing class.
   */
  public ReportPropertyFunctionTestCase(String name) {
    super(name);
  } // end of ReportPropertyFunctionTestCase(String name)
  /**
  ...
  protected void setUp() {
    varReportPropertyFunction = new ReportPropertyFunction();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(ReportPropertyFunctionTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetField() {
    ...
    varReportPropertyFunction.setField((String)null);
    assertEquals((String)null, varReportPropertyFunction.getField());
    varReportPropertyFunction.setField((String)"");
    assertEquals((String)"", varReportPropertyFunction.getField());
    varReportPropertyFunction.setField((String)"\u0000");
    assertEquals((String)"\u0000", varReportPropertyFunction.getField());
    varReportPropertyFunction.setField((String)" ");
    assertEquals((String)" ", varReportPropertyFunction.getField());
    varReportPropertyFunction.setField((String)"\n");
    assertEquals((String)"\n", varReportPropertyFunction.getField());
...
} // end of ReportPropertyFunctionTestCase
