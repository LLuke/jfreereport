 ...
 *
 * $Id: SimpleDateFormatFilterTestCase.java,v 1.1 2002/07/08 22:10:37 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>SimpleDateFormatFilterTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.filter.SimpleDateFormatFilterTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class SimpleDateFormatFilterTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected SimpleDateFormatFilter varSimpleDateFormatFilter;

  /**
   * Public constructor for creating testing class.
   */
  public SimpleDateFormatFilterTestCase(String name) {
    super(name);
  } // end of SimpleDateFormatFilterTestCase(String name)
  /**
  ...
  protected void setUp() {
    varSimpleDateFormatFilter = new SimpleDateFormatFilter();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(SimpleDateFormatFilterTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetFormatString() {
    ...
    varSimpleDateFormatFilter.setFormatString((String)null);
    assertEquals((String)null, varSimpleDateFormatFilter.getFormatString());
    varSimpleDateFormatFilter.setFormatString((String)"");
    assertEquals((String)"", varSimpleDateFormatFilter.getFormatString());
    varSimpleDateFormatFilter.setFormatString((String)"\u0000");
    assertEquals((String)"\u0000", varSimpleDateFormatFilter.getFormatString());
    varSimpleDateFormatFilter.setFormatString((String)" ");
    assertEquals((String)" ", varSimpleDateFormatFilter.getFormatString());
    varSimpleDateFormatFilter.setFormatString((String)"\n");
    assertEquals((String)"\n", varSimpleDateFormatFilter.getFormatString());
   ...
   * from tested class
   */
  public void testGetLocalizedFormatString() {

    varSimpleDateFormatFilter.setLocalizedFormatString((String)null);
    assertEquals((String)null, varSimpleDateFormatFilter.getLocalizedFormatString());
    varSimpleDateFormatFilter.setLocalizedFormatString((String)"");
    assertEquals((String)"", varSimpleDateFormatFilter.getLocalizedFormatString());
    varSimpleDateFormatFilter.setLocalizedFormatString((String)"\u0000");
    assertEquals((String)"\u0000", varSimpleDateFormatFilter.getLocalizedFormatString());
    varSimpleDateFormatFilter.setLocalizedFormatString((String)" ");
    assertEquals((String)" ", varSimpleDateFormatFilter.getLocalizedFormatString());
    varSimpleDateFormatFilter.setLocalizedFormatString((String)"\n");
    assertEquals((String)"\n", varSimpleDateFormatFilter.getLocalizedFormatString());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varSimpleDateFormatFilter.setLocalizedFormatString((String)null);
    assertEquals((String)null, varSimpleDateFormatFilter.getLocalizedFormatString());
    varSimpleDateFormatFilter.setLocalizedFormatString((String)"");
  ...
  } // end of testGetLocalizedFormatString()
  ...
  public void testGetSimpleDateFormat() {
    ...
    varSimpleDateFormatFilter.setSimpleDateFormat((java.text.SimpleDateFormat)null);
    assertEquals((java.text.SimpleDateFormat)null, varSimpleDateFormatFilter.getSimpleDateFormat());
    assertTrue("Warning! This new test method with no real test code inside.", false);
    varSimpleDateFormatFilter.setSimpleDateFormat((java.text.SimpleDateFormat)null);
    assertEquals((java.text.SimpleDateFormat)null, varSimpleDateFormatFilter.getSimpleDateFormat());

  } // end of testGetSimpleDateFormat()

  /**
   * Method for testing how works original method:
   * void setFormatString(java.lang.String)
   * from tested class
   */
  public void testSetFormatString1195259493() {
  ...
  } // end of testSetFormatString1195259493(java.lang.String)
  ...
  /**
   * Method for testing how works original method:
   * void setLocalizedFormatString(java.lang.String)
   * from tested class
   */
  public void testSetLocalizedFormatString1195259493() {
  ...
  } // end of testSetLocalizedFormatString1195259493(java.lang.String)

  /**
   * Method for testing how works original method:
   * void setSimpleDateFormat(java.text.SimpleDateFormat)
   * from tested class
   */
  public void testSetSimpleDateFormat1539653772() {
  ...
  } // end of testSetSimpleDateFormat1539653772(java.text.SimpleDateFormat)

} // end of SimpleDateFormatFilterTestCase
