 ...
 *
 * $Id: DateElementTestCase.java,v 1.1 2002/07/08 22:10:35 taqua Exp $
 * $Author: taqua $
...
/**
 * File <code>DateElementTestCase.java</code> is automaticaly generated by
 ...
 *     <pre>
 *       java -cp "jar/thisjarfile.jar;lib/junit.jar" com.jrefinery.report.DateElementTestCase
 *     </pre>
 *   </li>
 ...
 * </ul>
 */
public class DateElementTestCase extends TestCase
{
  /**
   * Instance of tested class.
   */
  protected DateElement varDateElement;

  /**
   * Public constructor for creating testing class.
   */
  public DateElementTestCase(String name) {
    super(name);
  } // end of DateElementTestCase(String name)
  /**
  ...
  protected void setUp() {
     varDateElement = new DateElement();
  } // end of setUp()
  /**
  ...
  public static Test suite() {
    return new TestSuite(DateElementTestCase.class);
  } // end of suite()
  /**
  ...
  public void testGetFormatter() {
    ...
    varDateElement.setFormatter((java.text.DateFormat)null);
    assertEquals((java.text.DateFormat)null, varDateElement.getFormatter());
