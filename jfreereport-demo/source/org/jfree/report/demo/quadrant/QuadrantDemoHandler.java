 ...
 */
public class QuadrantDemoHandler extends AbstractXmlDemoHandler
{
  public QuadrantDemoHandler()
  {
  }
  ...
  {
    return ObjectUtilities.getResourceRelative("quadrant-demo.html", QuadrantDemoHandler.class);
  }
  ...
  {
    return ObjectUtilities.getResourceRelative("quad.xml", QuadrantDemoHandler.class);
  }
}
