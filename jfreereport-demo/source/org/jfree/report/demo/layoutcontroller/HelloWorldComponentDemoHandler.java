 ...
 *
 * ------------
 * HelloWorldComponentDemoHandler.java
 * ------------
 * (C) Copyright 2006-2007, by Pentaho Corporation.
 */

package org.jfree.report.demo.layoutcontroller;
 ...
 */
public class HelloWorldComponentDemoHandler extends AbstractXmlDemoHandler
{
  private CountryDataTableModel data;

  public HelloWorldComponentDemoHandler()
  {
  ...
  {
    return "A demo showing how to construct a new layout-controller.";
  }
  ...
  public ReportJob createReport() throws ReportDefinitionException
  {
    ...
    final TableReportDataFactory dataFactory =
        new TableReportDataFactory("default", new DefaultTableModel());
  ...
  {
    return ObjectUtilities.getResourceRelative("hello-world-component.html", HelloWorldComponentDemoHandler.class);
  }
  ...
  {
    return ObjectUtilities.getResourceRelative("hello-world-component.xml", HelloWorldComponentDemoHandler.class);
  }
}
