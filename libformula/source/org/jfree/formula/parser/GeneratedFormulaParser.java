 ...
 *
 * ------------
 * $Id: GeneratedFormulaParser.java,v 1.8 2007/05/07 22:52:34 mimil Exp $
 * ------------
...
public abstract class GeneratedFormulaParser implements GeneratedFormulaParserConstants {
  ...
  PostfixOperator postfixOp = null;
    ...
    case NULL:
      ...
      break;
    case L_BRACE:
      value = jj_consume_token(L_BRACE);
      retval = parseArray();
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0xf8000000,0xf8000000,0x18000000,0x1080100,0x0,0x19180100,0x4000000,0x40000,0x190c0100,0x40000,0x19080100,0x190c0100,0x18000000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x7f,0x7f,0x0,0x10f00,0x80,0x10f00,0x0,0x0,0x10f00,0x0,0x10f00,0x10f00,0x0,};
   }
