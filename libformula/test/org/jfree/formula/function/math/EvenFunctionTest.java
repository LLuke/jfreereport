 ...
 *
 * ------------
 * $Id: OddFunctionTest.java,v 1.1 2007/05/17 23:32:11 mimil Exp $
 * ------------
...
public class EvenFunctionTest
{
  ...
  public Object[][] createDataTest()
  {
    return new Object[][]
    {
    { "EVEN(6)", new Integer(6) },
    { "EVEN(-4)", new Integer(-4) },
    { "EVEN(1)", new Integer(2) },
    { "EVEN(0.3)", new Integer(2) },
    { "EVEN(-1)", new Integer(-2) },
    { "EVEN(-0.3)", new Integer(-2) },
    { "EVEN(0)", new Integer(0) },
    };
  }
