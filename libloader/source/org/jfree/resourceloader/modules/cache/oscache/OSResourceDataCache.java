...
public class OSResourceDataCache implements ResourceDataCache
{
  ...
  public OSResourceDataCache(final GeneralCacheAdministrator dataCache)
  {
    if (dataCache == null)
    {
  ...
  public ResourceDataCacheEntry get(ResourceKey key)
  {
    ...
    try
    {
      return (ResourceDataCacheEntry) dataCache.getFromCache(ext);
    }
    catch (NeedsRefreshException e)
    {
      dataCache.cancelUpdate(ext);
      dataCache.removeEntry(ext);
      return null;
    }
  }
  ...
  public ResourceData put(ResourceData data)
  {
    ...
    dataCache.putInCache(ext, new DefaultResourceDataCacheEntry(cdata));
    return cdata;
  }
